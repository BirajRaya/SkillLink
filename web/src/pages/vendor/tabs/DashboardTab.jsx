          ...
          <CardContent className="pt-4">
            <div className="text-2xl font-bold flex items-center">
              ...
              <div className="ml-2 flex">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className={`w-4 h-4 ${i < Math.floor(dashboardStats.averageRating) ? 'text-yellow-400' : 'text-gray-200'}`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
